...
ALTER TABLE "public"."command" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: command command_hash_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."command"
    ADD CONSTRAINT "command_hash_key" UNIQUE ("hash");
...
ALTER TABLE ONLY "public"."command"
    ADD CONSTRAINT "command_pkey" PRIMARY KEY ("id", "hash");


--
-- Name: command; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."command" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."command" TO "anon";
GRANT ALL ON TABLE "public"."command" TO "authenticated";
GRANT ALL ON TABLE "public"."command" TO "service_role";


--
-- Name: SEQUENCE "command_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
